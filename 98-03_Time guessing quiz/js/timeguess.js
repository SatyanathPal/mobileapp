...
start.addEventListener(
  ...
  function () {
    ...
    startTime = Date.now();
    countUp();
    sound.start.play(); //new add for sound
  },
  false
);
...
stop.addEventListener(
  ...
  function () {
    ...
    // new add for sound
    if (stopTime >= 10000 && stopTime < 11000) {  // new add for sound
      sound.success.play();
...
reset.addEventListener("click",
  function () {
    ...
    stopTime = 0;
    sound.reset.play();     //new add for sound
